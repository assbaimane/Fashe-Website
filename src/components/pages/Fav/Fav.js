            ...
            {props.favBag != "" &&
                <div id='FavContent' className='m-5'>
                    <div id ='FavContentTitle' className="row d-flex align-items-center justify-content-center container text-center m-0">
                        <p className='col-md-6 col-12 ps-0'>Product</p>
                        <p className='col-md-2 col-6 text-center'>Price</p>
                        <p className='col-md-4 col-6 pe-0'>I want it !</p>
                    </div>
                        ...
                        {props.favBag.map((element, index) => {
                            return (
                                <div className="items row align-items-center justify-content-center align-items-center container text-center m-0">
                                    ...
                                    <p className='col-md-2 col-6 m-0'>${element.price}.00</p>
                                    <button className='col-md-4 col-6' onClick={() =>props.fromFavToBag(element,index)}>Add to Bag </button>
                                </div>
                            );
                        }
                        )}
